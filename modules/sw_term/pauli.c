...
* File pauli.c
*
* Copyright (C) 2005, 2009, 2011, 2013, 2021 Martin Luescher
*
...
*     Multiplies the Weyl spinor s by the matrix m[0]+i*mu and assigns
...
*     Multiplies the upper and lower Weyl spinors of s by m[0]+i*mu and
*     m[1]-i*mu, respectively, and assigns the result to the spinor r. The
*     source spinor is overwritten if r=s and otherwise left unchanged.
*
...
* thread-safe. If SSE or AVX instructions are used, the Pauli matrices, Weyl
* and Dirac spinors must be aligned to a 16 byte boundary.
*
*******************************************************************************/
