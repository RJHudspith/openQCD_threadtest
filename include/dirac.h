...
/* DW_C */
extern void Dw(const float mu,spinor *s,spinor *r);
extern void Dwee(const float mu,spinor *s,spinor *r);
extern void Dwoo(const float mu,spinor *s,spinor *r);
extern void Dweo(spinor *s,spinor *r);
extern void Dwoe(spinor *s,spinor *r);
extern void Dwhat(const float mu,spinor *s,spinor *r);
...
/* DW_DBLE_C */
extern void Dw_dble(const double mu,spinor_dble *s,spinor_dble *r);
extern void Dwee_dble(const double mu,spinor_dble *s,spinor_dble *r);
extern void Dwoo_dble(const double mu,spinor_dble *s,spinor_dble *r);
extern void Dweo_dble(spinor_dble *s,spinor_dble *r);
extern void Dwoe_dble(spinor_dble *s,spinor_dble *r);
extern void Dwhat_dble(const double mu,spinor_dble *s,spinor_dble *r);
